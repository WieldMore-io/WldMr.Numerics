...
- Forked files keep upstream's 4-space indentation, license headers, `#nowarn "77" "1182"` and `// fsharplint:disable` lines — **do not reformat them**, it destroys diffability against upstream DiffSharp. (The repo's own `.editorconfig` style applies everywhere else.)
