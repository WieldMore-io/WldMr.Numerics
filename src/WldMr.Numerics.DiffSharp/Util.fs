...
module ErrorMessages =
    ...
    let InvalidArgMColsMRows() = invalidArg "" "Number of columns of first matrix must match number of rows of second matrix."
